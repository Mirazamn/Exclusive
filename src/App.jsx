  ...
  return (
    <>
      ...
      <div className='flex justify-between items-center px-[50px] py-[20px]'>
        ...
        <button className='cursor-pointer py-[16px] px-[48px] border-solid border'>Move All To Bag</button>
      </div>

      <div className="cards flex flex-wrap justify-center gap-y-[40px]">
